	...
	**/
    pp.log = function(what, lvl, obj, logger) {
        if (console != undefined) {
            ...
            if(logger.levels.getName(lvl).toLowerCase() == "error"){
               console.error(logger.name + ' :: ' + logger.levels.getName(lvl) + ' : ' + what);          
            }else{
